...
function bgBlocklyLanguage() {
//===========================
// Création d'une classe pour traduire les texte de l'application dans divers langues
this.HTML_WIN_TITLE = "ex0810, cards, multilanguages version";
...
function Test1() {
//===========================
var gloPar = new bgBlocklyLanguage();

//Display(gloPar + '\n');
//Display(gloPar.HTML_WIN_TITLE + '\n');
Display(gloPar['HTML_WIN_TITLE'] + '\n');
//Display(gloPar.length + '\n'); // undefined

// Parcours tous les éléments de l'objet
var oo;
for (oo in gloPar) {
  //Display('[' + oo + ']' + gloPar[oo] + '\n');
  document.getElementById(oo).innerHTML = gloPar[oo]; // Fonctionne très bien
  }
} // Test1
...
// ° la toolbox
// ° la startBlocks
// ° les langues dans le fichier msg/ .xml
