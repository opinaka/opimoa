...
if (glnTime >= nTimeMax) { // L'animation dure  nTimeMax  milli-secondes
  ...
  gloField.setTooltip(gloB.oLanguage.TEXT_MOUSE_BURNED1); // Change le texte d'aide associé à l'objet
  gloField.setValue('images/puzzle_mouse_burned.jpg'); // Change l'image de la souris
  gloField.setText(gloB.oLanguage.TEXT_MOUSE_BURNED2); // Change le texte associé à la souris
  gloField = null;
    ...
    if (code.indexOf('PLUG_Desktop>Ecran-Clavier.LIFE', 0) >= 0) {
      ...
      if (glnMessageOn) {
        if (code.length <= 31) {
          ...
          alert(gloB.oLanguage.TEXT_CONGRATULATION);
          glnMessageOn = false; // Ne réaffiche plus de message
          document.body.removeChild(divElement);  // Element supprimé de la mémoire.
          }
        else {
          alert(gloB.oLanguage.TEXT_CLEANING_TO_DO);
      ...
      alert(gloB.oLanguage.TEXT_CONNECTION_REMAINING);
...
//""""""""""""""""""""""""""""""""""
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("images/puzzle_notebook.jpg", 100, 100, "Ordinateur portable"));
    this.setOutput(true, null);
    this.setColour(bgBlockly.Msg['PUZZLE_COMPUTER_HUE']);
    this.setTooltip(bgBlockly.Msg['PUZZLE_NOTEBOOK_TOOLTIP']);
    this.setHelpUrl("");
  }
};
...
//""""""""""""""""""""""""""""""""""
  init: function() {
    ...
    this.setOutput(true, null);
    this.setColour(bgBlockly.Msg['PUZZLE_COMPUTER_HUE']);
    this.setTooltip(bgBlockly.Msg['PUZZLE_SCREEN_TOOLTIP']);
    this.setHelpUrl("");
  }
};
...
//""""""""""""""""""""""""""""""""""""
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("images/puzzle_keyboard.jpg", 100, 100, "Clavier"));
    this.setOutput(true, null);
    this.setColour(bgBlockly.Msg['PUZZLE_COMPUTER_HUE']);
    this.setTooltip(bgBlockly.Msg['PUZZLE_KEYBOARD_TOOLTIP']);
    this.setHelpUrl("");
  }
};
...
//""""""""""""""""""""""""""""""""""""
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("images/puzzle_mouse.jpg", 100, 100, "Souris"), 'myMouse');
    this.setOutput(true, null);
    this.setColour(bgBlockly.Msg['PUZZLE_COMPUTER_HUE']);
    this.setTooltip(bgBlockly.Msg['PUZZLE_MOUSE_TOOLTIP']);
    this.setHelpUrl("");
    this.data = 'LIFE';
  }
};
...
//""""""""""""""""""""""""""""""""
  init: function() {
    this.jsonInit({
      ...
      "inputsInline": false,
      "output": null,
      "colour": bgBlockly.Msg['PUZZLE_DESKTOP_HUE'],
...
//"""""""""""""""""""""""""""""""""""""
  init: function() {
    this.jsonInit({
      ...
      "inputsInline": false,
      "colour": bgBlockly.Msg['PUZZLE_POWER_PLUG_HUE'],
