...
Display("id=" + event.blockId + "\n");  // Retourne le texte alternatif de l'image
Display("typeof(id)=" + typeof(demoWorkspace.getBlockById(event.blockId)) + "\n"); // retourn : object
Display("event.type=" + event.type + "\n"); 
//Display("workspaceId=" + Blockly.Workspace.getById(event.workspaceId) + "\n"); // ? utile ?
//Display("event.group=" + event.group + "\n"); 
Display("\n"); 
...
alert("Dans ce programme, il n'y a pas de code à exécuter");
} // runCode
...
//""""""""""""""""""""""""""""""""""""
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("puzzle_mouse.jpg", 100, 100, "Souris2"), 'myMouse');
    this.setOutput(true, null);
    this.setColour(90);
...
//=======================================================
// N'a rien donné.  Je veux pouvoir modifier l'image d'un block.
/*
// c.f. https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Objets_globaux/Object
//Display(Blockly.Blocks['puzzle_mouse'] + "\n");
//Display(Object.keys(Blockly.Blocks['puzzle_mouse']) + "\n");
//Display(Object.entries(Blockly.Blocks['puzzle_mouse']) + "\n");
//Display(Blockly.Blocks['puzzle_mouse'].init + "\n");


//Blockly.Blocks['puzzle_mouse'].removeField('puzzle_mouse'); // Ne marche pas

//Display(typeof(this) + "\n");
//Display(Object.keys(this) + "\n");
//Display(Object.entries(this) + "\n");
//Display(Object.getOwnPropertyNames(this) + "\n");
//Display(Object.getOwnPropertyDescriptor(this, 'id').value + "\n"); // Récupère l'id de l'élément html de la "mouse"
var myid = Object.getOwnPropertyDescriptor(this, 'id').value; // Récupère l'id de l'élément html de la "mouse"
//Display(document.getElementById(myid) + "\n"); // Retourn 'nul', donc pas utile.

Display(myid + "\n");
Display(document.getElementById(myid) + "\n"); // Retourn 'nul', donc pas utile.

//Display(Object.getOwnPropertyDescriptor(this, 'inputList').value + "\n");
var obj1 = Object.getOwnPropertyDescriptor(this, 'inputList');
//Display(Object.entries(obj1) + "\n");

var obj2 = Object.getOwnPropertyDescriptor(obj1, 'value');

//Display(Object.entries(obj2) + "\n");

//Display(Object.getOwnPropertyDescriptor(obj2, 'value') + "\n");


//this.appendDummyInput().removeField('puzzle_mouse');
//this.appendDummyInput().removeField('pu');

// Ajoute un clavier sous la souris
// c.f. Blockly/core/input.js
//this.appendDummyInput().appendField(new Blockly.FieldImage("puzzle_keyboard.jpg", 100, 100, "Souris morte"));
*/

// c.f. https://developers.google.com/blockly/reference/js/Blockly.Workspace
//Display(demoWorkspace.id + "\n"); // Retourn bien une id

//Display(demoWorkspace.getAllBlocks(true) + "\n"); // Retourn tous les Blockly.Block  de la Workspace

//Display(demoWorkspace.getAllBlocks(true)[1] + "\n");  // Retourn : l'objet : Souris
//var mySouris = demoWorkspace.getAllBlocks(true)[1];  // Retourn : l'objet : Souris


// glnObject  est un Blockly.Block
 
//var myField = Blockly.Blocks['puzzle_mouse'].getField('myMouse');
//var myField = Blockly.Blocks['puzzle_mouse'].id;
//Display(myField + "\n");


//var myField = mySouris.getField('myMouse'); // Champ qui doit contenir un "FieldImage" ???

//if ( (glnObject === mySouris) && (glnObject === mySouris2) ) {
if ( glnObject != null ) {
...
//  var myField = mySouris.getField('myMouse'); // Champ qui doit contenir un "FieldImage" ???
  ...
  if (myField != null) {
    ...
    //myField.setTooltip('Nouvel aide...'); // Change le texte d'aide associé à l'objet
    //myField.setText('nouveau Texte'); // Change le texte associé à l'objet

    myField.setValue('puzzle_keyboard.jpg'); // Change l'image de la souris
