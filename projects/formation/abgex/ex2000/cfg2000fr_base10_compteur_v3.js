// cfg2000_base10fr_compteur_v3.js
...
//-------------------------------------------------
/*
Ce fichier de configuration défini un compteur en base 10.
 */
// ########################################################################################
...
nn += 1;
glaoFrames[nn].posX = glaoFrames[nn-1].posX + glaoFrames[nn-1].deltaX + 30;
...
// n°, posX, posY, texte
CardTextWrite(0, 34, 160, "10^3         10^2         10^1          10^0");


// Écriture de texte par dessus l'avant-dernière carte, celle qui est blanche
CardTextWrite(1, glaoFrames[6].posX + 5, glaoFrames[6].posY + 24, "Suivant");

// Écriture de texte par dessus la dernière carte, celle qui est blanche
glaoTexts[2].color = "#400000";
CardTextWrite(2, glaoFrames[7].posX + 5, glaoFrames[7].posY + 24, "Reset");

// Devra être ajouté pour l'utilisateur
glaoTexts[3].color = "#0000ff";
CardTextWrite(3, glaoFrames[5].posX + 5, glaoFrames[5].posY + 24, "Précédent");
...
// 7 = la case, 1 = la profondeur = dessus, 'data-param1' est le nom du paramètre et '0' la valeur qu'on lui donne.
//CardSetParam(7, 1, 'data-param1', '0'); // Pas nécessaire
} // confCardsInit
...
+ "&nbsp; Exemple d'un compteur en base 10 &nbsp;<br>"
+ "&nbsp; C'est la manière de compter en base 10. &nbsp;<br>"
+ "&nbsp; En base 10 : <b>9 + 1 = 10</b>.<br>"
+ "&nbsp;<br>"
+ "&nbsp; Exécuter le programme, il ne se passera rien, c'est normal. &nbsp;<br>"
+ "&nbsp; En cliquant sur les boutons, le compteur changera."
;

// Changement du titre du message
document.getElementById('HTML_MESSAGE').innerHTML =
  "&nbsp; Un compteur en base 10. &nbsp;"
;
...
document.getElementById('HTML_ABOUT1').innerHTML =
  "&nbsp; Montre l'exemple de programmer un compteur en base 10. &nbsp;"
;
