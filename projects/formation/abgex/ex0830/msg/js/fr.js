...
Blockly.Msg["CATEGORY_NAME_FUNCTIONS"] = "Fonctions";
  ...
  this.HTML_WIN_TITLE = "ex0830, cartes, version multilanges.";
  ...
  this.HTML_IMG_RUN = "Lance le programme défini par les blocs dans l'espace de travail.";
...
gloLanguage = new bgBlocklyLanguage_fr(); // Défini un objet contenant les traductions
gloLanguage2 = new bgBlocklyLanguage2_fr(); // Défini un objet contenant les traductions
