...
var demoWorkspace = null; // Cette variable doit être global.
...
var gloLanguage = null; // Objet contenant la langue chargée. Initialisée dans  msg/js/fr.js ou msg/js/en.js ou msg/js/de.js
var gloLanguage2 = null; // Objet contenant la langue chargée pour les 'title' des images.
...
// ° la toolbox
// ° la startBlocks
// ° les langues dans le fichier msg/ .js
//*************************
...
var oBalise;
if (gloLanguage) {
  for (oo in gloLanguage) {  
    oBalise = document.getElementById(oo);
    if (oBalise) oBalise.innerHTML = gloLanguage[oo];
    //Display('[' + oo + '] : ' +  gloLanguage[oo] + '\n'); // Pour des tests
    }
  }
...
if (gloLanguage2) {
  for (oo in gloLanguage2) {  
    oBalise = document.getElementById(oo);
    if (oBalise) oBalise.setAttribute('title', gloLanguage2[oo]);
    //Display('[' + oo + '] : ' +  gloLanguage2[oo] + '\n'); // Pour des tests
    }
  }
...
glstrbgLanguage = strS.substr(n1+6, 20); // récupère la langue désirée = 'de' ou  = 'en' ou  = 'fr'
