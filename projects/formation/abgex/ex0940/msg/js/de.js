...
// Messages de Blockly
Blockly.Msg["CATEGORY_NAME_LOGO"] = "Bewegen";

// To translate in german the texts contained in the "innerHTML" tags having the id : "HTML_..."
// ==============================================================================================
gloB.oLanguage.HTML_WIN_TITLE = "ex0940, Labyrinthe, DEUTSCHE VERSION in den Haupt Title";
gloB.oLanguage.HTML_MAIN_TITLE = "(de)Solve this labyrinthe...";
...
gloB.oDialog.DialogTitle = [
   "Mitteilung"  // Message d'aide
  ,"(de)About this programm" // Message About
  ,""
  ];
