...
bgBlockly.Msg["TEXT_AFFICHE_EFFACE_TITLE"] = "Clear the Display";
...
bgBlockly.Msg['TEXT_COMMENT_TOOLTIP'] = "A comment";
...
Blockly.Msg["CATEGORY_NAME_FUNCTIONS"] = "Functions";
  ...
  //===============================
  // Class to translate in english the texts contained in the "innerHTML" tags having the id : "HTML_..."
...
//this.HTML_ABOUT2 = "Text in the local messages : /msg/js/...";
  ...
  this.XML_TB_COMMENT = "write a comment...";
  
  } // bgBlocklyLanguage_en

  function bgBlocklyLanguage2_en() {
  //===============================
  // Class to translate in english the texts in the "title" attribute of the tags having the id : "HTML_IGM_..."
  this.HTML_IMG_OPEN = "Open a Blockly file...";
  this.HTML_IMG_SAVE = "Save a Blockly file...";
  this.HTML_IMG_RUN = "Execute the programm defined by the blocks in the working space.";
  this.HTML_IMG_RUNRUN = "Execute faster the programm.";
  this.HTML_IMG_RUNRUNRUN = "Execute very fast the programm, without animation.";
  this.HTML_IMG_ONESTEP = "Execute one step of the code.";
  this.HTML_IMG_PAUSE = "Pause the programm execution.";
  this.HTML_IMG_STOP = "Stop the programm execution.";
  this.HTML_IMG_FASTER = "Run faster.";
  this.HTML_IMG_SLOWER = "Run slower.";
  this.HTML_IMG_HELP = "Help.";
  this.HTML_IMG_CODEJAVASCRIPT = "Show the javascript code.";
  } // bgBlocklyLanguage2_en

gloB.oLanguage  = new bgBlocklyLanguage_en();  // Défine an objet containing the translation of the "innerHTML"
gloB.oLanguage2 = new bgBlocklyLanguage2_en(); // Défine an objet containing the translation of the "title"
