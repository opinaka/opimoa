...
bgBlockly.Msg['TEXT_COMMENT_TOOLTIP'] = "Um commentar";
...
// TO BE TRANSLATED
  ...
  //===============================
  // Class to translate in spanish the texts contained in the "innerHTML" tags having the id : "HTML_..."
...
//this.HTML_ABOUT2 = "Text in the local messages : /msg/js/...";
  ...
  this.XML_TB_COMMENT = "Escreve um commentar...";

  } // bgBlocklyLanguage_es
// TO BE TRANSLATED
  function bgBlocklyLanguage2_es() {
  //===============================
  // Class to translate in spanish the texts in the "title" attribute of the tags having the id : "HTML_IGM_..."
...
gloB.oLanguage = new bgBlocklyLanguage_es();   // Défine an objet containing the translation of the "innerHTML" 
gloB.oLanguage2 = new bgBlocklyLanguage2_es(); // Défine an objet containing the translation of the "title"
