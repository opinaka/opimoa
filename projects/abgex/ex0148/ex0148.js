...
window.document.nomForm4.nomTextarea4.scrollTop = 100000;  // pour rester en fin du texte.
} // showCodeLua
...
//===============================================
// Défini la fonctionnalité du bloc
var msg = Blockly.Lua.valueToCode(block, 'TEXT', Blockly.JavaScript.ORDER_NONE) || '\'\'';
return "print(" + (  msg + " .. '\\n'") + ")\n"; // Insertion d'un retour de ligne à la fin de l'affichage : "\n"
};
