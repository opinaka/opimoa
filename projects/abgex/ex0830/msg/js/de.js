...
Blockly.Msg["CATEGORY_NAME_FUNCTIONS"] = "Functions";
  ...
  this.HTML_WIN_TITLE = "ex0830, DEUTSCHE VERSION in den Haupt Title";
...
gloLanguage  = new bgBlocklyLanguage_de(); // Défini un objet contenant les traductions
gloLanguage2 = new bgBlocklyLanguage2_de(); // Défini un objet contenant les traductions
