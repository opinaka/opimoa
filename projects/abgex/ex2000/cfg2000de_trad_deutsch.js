...
document.getElementById('HTML_CONFIGURE').innerHTML = "Konfiguration...";

// All files : cfg2000fr_*.js  should be changed to cfg2000de_*.js
// and the contents of the files should be translated in german.
