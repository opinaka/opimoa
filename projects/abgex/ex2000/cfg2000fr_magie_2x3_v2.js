...
L'ordinateur retrouve la carte choisie par l'utilisateur du programme.
Adjonction de fonctionnalité à la version 1.
*/
// ########################################################################################
...
+'\n    </next>'
+'\n  </block>'
+'\n  <block type="procedures_defnoreturn" x="10" y="180">'
+'\n    <mutation>'
+'\n      <arg name="nCadre" varid="LyAx-~eG4]_#6yP]fq6x"></arg>'
+'\n    </mutation>'
...
+'\n    </statement>'
+'\n  </block>'
+'\n  <block type="procedures_defnoreturn" x="10" y="740">'
...
nn += 1;
glaoFrames[nn].posX = glaoFrames[8].posX + glaoFrames[8].deltaX;
glaoFrames[nn].posY = glaoFrames[8].posY + glaoFrames[8].deltaY + 30;
...
+ "&nbsp; Après avoir exécuté trois fois de suite l'instruction suivante, &nbsp;<br>"
