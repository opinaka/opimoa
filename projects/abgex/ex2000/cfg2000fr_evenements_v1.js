...
+'\n    <value name="COMMENT">'
+'\n      <shadow type="text">'
+"\n        <field name='TEXT'>Cliquer sur l'As pour terminer</field>"
+'\n      </shadow>'
+'\n    </value>'
+'\n    <next>'
+'\n      <block type="card_reset_click_count">'
...
var nXmax = 3; // nombre de colonnes
var nYmax = 4; // nombre de lignes
var nn = 0;
...
gloCanvas.nbCards = glnFramesMax; // Nombre de cartes placées
for (nn=1; nn<=gloCanvas.nbCards; nn++) { // Pour créer des instances de cartes
    nCardFace = 300 + nn;
    nCase = nn;
    if (2*nn > gloCanvas.nbCards) nCardFace = 100 + nn;
