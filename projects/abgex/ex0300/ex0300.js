...
//===================
if (glnTimerID1 != 0) {
  // Attend que la boule bleue soit arrêtée pour continuer.
...
wrapper = function(text) {
  return Display(arguments.length ? text : '');
  };
interpreter.setProperty(scope, 'Display', interpreter.createNativeFunction(wrapper));

// Ajoute une 'API function' pour le  block 'Display'
wrapper = function(idImage, nStopPosX, nStopPosY, delayMS) {
  return GotoXY(idImage, nStopPosX, nStopPosY, delayMS);
  };
